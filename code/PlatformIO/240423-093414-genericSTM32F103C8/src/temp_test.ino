...
#define TEMPPIN PB1
#define CONTAINERPIN PB4 //PA5
#define DOUGHPIN PC14
#define CONFIRMPIN PB5 // PA6
#define CANCELPIN PB6 // PA7
...
******/
VCNL3040 sens;
Screen_EPD_EXT3 myScreen(eScreen_EPD_266_QS_0F, board445Custom);
...
void displaySensorReadings(double start_height, double current_height, double peak_height, double current_temperature)
{
    ...
    myScreen.dRectangle(dx * 0, dy * 0, dx, dy, myColours.yellow);
    myScreen.dRectangle(dx * 0, dy * 1, dx, dy, myColours.white);
    myScreen.dRectangle(dx * 0, dy * 2, dx, dy, myColours.black);
    myScreen.dRectangle(dx * 0, dy * 3, dx, dy, myColours.red);

    myScreen.setFontSolid(false);
    myScreen.gText(dx * 0 + 4, dy * 0 + 4, s_start_height, myColours.black);
    myScreen.gText(dx * 0 + 4, dy * 1 + 4, s_current_height, myColours.black);
    myScreen.gText(dx * 0 + 4, dy * 2 + 4, s_peak_height, myColours.white);
    myScreen.gText(dx * 0 + 4, dy * 3 + 4, s_current_temperature, myColours.white);
